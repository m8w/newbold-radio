...
`Newbold_Archive_Manifest_2026-02-13.csv` contains the full index of 86,743 YouTube videos across six channels. All videos are publicly available. The CSV is included here for reproducibility and to avoid repeated API calls on startup.

Columns: `Channel`, `Title`, `Video_ID`, `Duration`, `YouTube_URL`
...
Newbold_Archive_Manifest_2026-02-13.csv   # YouTube video index (86,743 videos)
requirements.txt
README.md
.gitignore
```
